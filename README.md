...
[![Pytest](https://img.shields.io/badge/Pytest-10%2F10%20Passed-0A9EDC?style=flat-square&logo=pytest&logoColor=white)](./benchmarks)
...
Open [http://localhost:3000](http://localhost:3000) to view the interactive benchmark dashboard.
